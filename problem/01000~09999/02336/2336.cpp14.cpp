...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        int me = ranks[0][i];
        int meSecondRank = rankPos[1][me], meThirdRank = rankPos[2][me];

        int needThirdRank = Check(0, meSecondRank);
        if (meThirdRank < needThirdRank) ans++;
        Update(meSecondRank, meThirdRank);
    }
