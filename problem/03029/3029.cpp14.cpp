...
struct CTime {
  int hour, minute, second, timevalue;
};
...
int main() {
  ...
  start.timevalue = start.hour * 3600 + start.minute * 60 + start.second;
  finish.timevalue = finish.hour * 3600 + finish.minute * 60 + finish.second;
  
  if (start.timevalue < finish.timevalue)
    ans = finish.timevalue - start.timevalue;
  else
    ans = 86400 - (start.timevalue - finish.timevalue);
