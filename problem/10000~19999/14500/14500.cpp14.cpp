...
int Check(int si, int sj, pair<int, int> a, pair<int, int> b, pair<int, int> c, pair<int, int> d) {
  int imax = si + MAX4(a.$1, b.$1, c.$1, d.$1), jmax = sj + MAX4(a.$2, b.$2, c.$2, d.$2);
  if (imax > N || jmax > M) return 0;
  return field[si + a.$1][sj + a.$2] + field[si + b.$1][sj + b.$2] + field[si + c.$1][sj + c.$2] + field[si + d.$1][sj + d.$2];
}
...
int main() {
  ...
  for (int i = 1; i <= N; i++) {
    for (int j = 1; j <= M; j++) {
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {0,2}, {0,3}));
      answer = MAX(answer, Check(i, j, {0,0}, {1,0}, {2,0}, {3,0}));

      answer = MAX(answer, Check(i, j, {0,0}, {1,0}, {2,0}, {2,1}));
      answer = MAX(answer, Check(i, j, {2,0}, {0,1}, {1,1}, {2,1}));
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {1,1}, {2,1}));
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {0,2}, {1,0}));
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {1,0}, {2,0}));
      answer = MAX(answer, Check(i, j, {0,2}, {1,0}, {1,1}, {1,2}));
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {0,2}, {1,2}));
      answer = MAX(answer, Check(i, j, {0,0}, {1,0}, {1,1}, {1,2}));

      answer = MAX(answer, Check(i, j, {0,0}, {1,0}, {1,1}, {2,1}));
      answer = MAX(answer, Check(i, j, {0,1}, {1,0}, {1,1}, {2,0}));
      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {1,1}, {1,2}));
      answer = MAX(answer, Check(i, j, {0,1}, {0,2}, {1,0}, {1,1}));

      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {1,0}, {1,1}));

      answer = MAX(answer, Check(i, j, {0,0}, {0,1}, {0,2}, {1,1}));
      answer = MAX(answer, Check(i, j, {1,0}, {1,1}, {1,2}, {0,1}));
      answer = MAX(answer, Check(i, j, {0,1}, {1,1}, {2,1}, {1,0}));
      answer = MAX(answer, Check(i, j, {0,0}, {1,0}, {2,0}, {1,1}));
    }
  }
