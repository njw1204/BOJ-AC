...
int main() {
  ...
  while (!Q.empty()) {
    ...
    if (i.$1 + field[i.$1][i.$2] <= N && !visit[i.$1 + field[i.$1][i.$2]][i.$2]) {
      visit[i.$1 + field[i.$1][i.$2]][i.$2] = true;
      Q.push({ i.$1 + field[i.$1][i.$2], i.$2 });
      if (i.$1 + field[i.$1][i.$2] == N && i.$2 == N)
        return cout << "HaruHaru", 0;
    }
    if (i.$2 + field[i.$1][i.$2] <= N && !visit[i.$1][i.$2 + field[i.$1][i.$2]]) {
      visit[i.$1][i.$2 + field[i.$1][i.$2]] = true;
      Q.push({ i.$1, i.$2 + field[i.$1][i.$2] });
      if (i.$1 == N && i.$2 + field[i.$1][i.$2] == N)
        return cout << "HaruHaru", 0;
    }
  }
